...
//  duotinfm
//
//  Created by Vienta on 14/10/25.
//  Copyright (c) 2014年 Duotin Network Technology Co.,LTD. All rights reserved.
//
//https://github.com/duhovny/DeviceHardware  thx duhovny
...
+ (IPhoneInchType)inchType
{
    ...
    if ([platform isEqualToString:DH_MACHINE_IPOD_1_1])      return IPhoneInchType_3_5;
    if ([platform isEqualToString:DH_MACHINE_IPOD_2_1])      return IPhoneInchType_3_5;
    if ([platform isEqualToString:DH_MACHINE_IPOD_3_1])      return IPhoneInchType_3_5;
    if ([platform isEqualToString:DH_MACHINE_IPOD_4_1])      return IPhoneInchType_3_5;
    if ([platform isEqualToString:DH_MACHINE_IPOD_5_1])      return IPhoneInchType_4_0;
